...
def get_job_time(workflow_run_id, token=None):
    ...
    url = f"https://api.github.com/repos/huggingface/transformers/actions/runs/{workflow_run_id}/jobs?per_page=100&page=1"
    ...
    try:
        ...
        print(f"An error occurred while fetching job information:\n{traceback.format_exc()}")
