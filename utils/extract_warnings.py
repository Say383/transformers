...
def extract_warnings_from_single_artifact(artifact_path, targets):
        ...
        for line in fp:
            ...
            # This means we are outside the body of a warning
                ...
                try:
                    ...
                    logger.warning(f'Error extracting warnings from a single artifact: {e}')
                    continue
                buffer.append(line)
    ...
    if from_gh:
        ...
        try:
            ...
            logger.warning(f'{artifact_path} is either an invalid zip file or something else wrong. This file is skipped: {e}')
            logger.warning(
